...
for i = 1:length(String)
    switch String(i)
        ...
        otherwise
            ...
            if prod(CharSize)
              %If one of the character dimension is zero, do not add the charracter
              %otherwise there will be an "Index in position is invalid" error
              %For example, this error will occur for character ASCII 160 (non-breakable space)
              %Modification by R. Labarbe 13 Aug 2021
